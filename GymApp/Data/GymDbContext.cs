    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Permiso>(entity =>
        {
            ...
            entity.HasData(
                ...
                new Permiso { PermisoId = "Membresias.Crear", Modulo = "Membresias", Descripcion = "Crear membresías" },
                new Permiso { PermisoId = "Membresias.Renovar", Modulo = "Membresias", Descripcion = "Renovar membresías" },
                new Permiso { PermisoId = "Membresias.Editar", Modulo = "Membresias", Descripcion = "Editar detalles de membresías" },
                new Permiso { PermisoId = "Membresias.Congelar", Modulo = "Membresias", Descripcion = "Congelar membresía" },

...
## Notas Técnicas y Deuda de Diseño
### 1. Parpadeo de Iconos (FOUC - Flash of Unstyled Content)
- **Problema:** Los iconos de Lucide parpadean al navegar entre módulos debido al tiempo de renderizado del script del cliente.
- **Causa:** La página carga el HTML con etiquetas <i> vacías y el script las rellena milisegundos después.
- **Solución Propuesta:** Migrar iconos del Sidebar a SVG "inline" para garantizar renderizado instantáneo desde el servidor.
